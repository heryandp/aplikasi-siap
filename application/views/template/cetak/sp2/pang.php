  ...
  <section class="sheet">
    ...
    <table width="100%">
      <tr>
        <td>Nomor</td>
        <td>:</td>
        <td><?php echo 'PANG-'.$explode[1] ?></td>
        <td style="text-align: right;">Jakarta, <?php echo $tgl ?></td>
      </tr>
      <tr>
        <td>Hal</td>
        <td>:</td>
        <td>Panggilan Dalam Rangka Pemeriksaan</td>
        <td></td>
      </tr>
    </table>
    ...
    <p style="text-align: justify;">
      Diperintahkan untuk melakukan Pemeriksaan Kantor di bidang perpajakan terhadap perusahaan/pekerjaan
Saudara di bawah ini :
    ...
    <p class="isi">
      Untuk kelancaran jalannya pemeriksaan, diharapkan kedatangan Saudara ke kantor kami dengan
membawa buku, catatan, dan dokumen pendukung,sebagaimana terlampir, memberikan bantuan
sepenuhnya, serta memberikan keterangan yang diperlukan pada:
    </p>
    <table width="100%">
      <tr>
      ...
      <tr>
        <td>Tempat</td>
        <td>:</td>
        <td>Kantor Pelayanan Pajak Pratama Jakarta Grogol Petamburan</td>
      </tr>
      <tr>
        <td>Waktu</td>
        <td>:</td>
