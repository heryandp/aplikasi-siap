        ...
        <div class="box-body">
                <form class="form-horizontal" action="<?php echo $action; ?>" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control" name="nosp2" id="nosp2" value="" placeholder="PRIN-00000/WPJ.05/KP.0205/RIK.SIS/2019" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-md-2 control-label">Tanggal SP2</label>
                    <div class="col-md-2">
                        <input type="text" class="form-control" name="tglsp2" id="tglsp2" autocomplete="off" />
                    </div>
                  </div>
                  <div class="form-group">
                      ...
                      <div class="col-md-7">
                          <div data-role="dynamic-fields">
                            ...
                            for($i = 0; $i < 3; $i++){
                                ...
                                <div class="form-group">';
                                echo form_dropdown('pemeriksa[]', $dd_pemeriksa, $pemeriksa_selected, 'class="form-control select2-pemeriksa"');
                                echo '</div>
                                  <span>-</span>
                                  <div class="form-group">
