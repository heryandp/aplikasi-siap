        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "../grab/jsonsp2", "type": "POST"},
                    columns: [
                        {
                            "data": "id",
                            "orderable": false
                        ...
                        {   "targets": -1,
                            ...
                            render: function(data) {
                                return '<a href=#! id="detil-bro"><button type="button" title="Lihat Detil" class="btn btn-default btn-xs"><i class="fa fa-eye" aria-hidden="true"></i></button></a>'
                            },
                ...
                $('#mytable tbody').on( 'click', 'button', function () {
                    ...
                    // Modal Aksi
                    document.getElementById("detil-bro").href='../tabel_dafnom/sp2_detil/'+data['idKasus'];
                } );
            });
        </script>
