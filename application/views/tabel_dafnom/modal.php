        ...
        <div class="modal-body">
             <form id="form-input" class="form-horizontal">
                <div class="form-group">
                    <label class="col-md-3 control-label">No. Usulan</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="usulan" id="usulan" autocomplete="off" placeholder="ND-123" required/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">Tanggal Usulan</label>
                    <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="kode" id="kode" maxlength="4" autocomplete="off" required/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label">Wajib Pajak</label>
                    <div class="col-md-9">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label">SPTLB ?</label>
                    <div class="checkbox col-md-9">
                          <label><input type="checkbox" id="sptlb" onchange="sptlbcek()" value=""></label>
                    </div>
                </div>
                <div class="form-group tglsptlb-input">
                    <label class="col-md-3 control-label">Tanggal SPTLB</label>
                    <div class="col-md-9">
