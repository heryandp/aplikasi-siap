var aspectRatio='1:1.3'; // ratio of the image
...
var uploadingtext='Gambar sedang dimuat naik. Sila tunggu...'; // text for uploading
var creatingtext='Gambar profil sedang dimuat naik. Sila tunggu...'; // text for generating thumb
var selWidth=0;
var selHeight=0;
var alertText='Sila pilih gambar dahulu'; // text if there is no selection
...
$(document).ready(function() {
	...
	$("form.uploaderForm").submit(function() {
		...
		$('#upload_target').unbind().load( function(){
			...
			var img = base_url+$('#upload_target').contents().find('body ').html();			
			var img2 = $('#upload_target').contents().find('body ').html();	
